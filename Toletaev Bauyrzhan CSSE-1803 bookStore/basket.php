...
<div class="w3-content" style="max-width:1200px">
    ...
    <header class="w3-container w3-xlarge">
        <p class="w3-left">Your basket</p>
        <p class="w3-right">
            <a href="User.php" style="margin-right: 10px"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-90deg-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
