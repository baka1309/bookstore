...
<div class="w3-content" style="max-width:1200px">
    ...
    <header class="w3-container w3-xlarge">
        ...
        <p class="w3-right">
            <a href="basket.php" style="margin-right: 10px"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart-check-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://lh3.googleusercontent.com/proxy/NkHA_adX9NTimMyptL50_F_WUKoFl-siftisJlLz3jE30ZSbnKQ6h4dhUvRavPtSk8rzmmlAaqdC2MvhKTY8DzveO-qYJRGYKfGWleerMi6ZTJcHA8IfY8mXpCSCj8y2KIltSCnWpDg4Wt6_MPDARyMt4hdecGL5AaVE1eOFxQ" alt="Los Angeles" width="1250" height="500">
            </div>
