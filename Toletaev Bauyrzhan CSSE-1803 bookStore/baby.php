...
<div class="w3-center w3-padding-16">
    <h1>Baby books</h1></div>
    <div class="w3-row-padding w3-padding-16 w3-center" id="book">
        <div class="w3-quarter">
            <img src="51.jpg" height="407px" style="width:100%"/>
            <h4>Magic alphabet</h4>
            <p>By Georgy Ilyin<br><b>Cost 23$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="52.jpg" height="407px" style="width:100%"/>
            <h4>Карандаш и Самоделкин.</h4>
            <p>By Allan Russell<br><b>Cost 21$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="53.jpg" height="407px" style="width:100%"/>
            <h4>Ha ha dil.</h4>
            <p>By Gary Chapman<br><b>Cost 18$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="54.jpg"height="407px" style="width:100%"/>
            <h4>Aibolit.</h4>
    ...
    <div class="w3-row-padding w3-padding-16 w3-center">
        <div class="w3-quarter">
            <img src="55.jpg" height="407px" style="width:100%"/>
            <h4>Kind flashlight.</h4>
            <p>By Ivan Artemev<br><b>Cost 15$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="56.jpg" height="407px" style="width:100%"/>
            <h4>Red handkerchief.</h4>
            <p>By Maria Shukina<br><b>Cost 25$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="58.jpg" height="407px" style="width:100%"/>
            <h4>Travel of the blue arrow.</h4>
            <p>By Gary Chapman<br><b>Cost 18$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="57.jpg" height="407px" style="width:100%"/>
            <h4>Kid and Carlson.</h4>
