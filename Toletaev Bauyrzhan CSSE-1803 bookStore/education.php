...
<div class="w3-center w3-padding-16"><h1>Education</h1></div>
    <div class="w3-row-padding w3-padding-16 w3-center" id="book">
        <div class="w3-quarter">
            <img src="11.jpg"  style="width:100%"/>
            <h4>Innovation in education</h4>
            <p>By Georgy Ilyin<br><b>Cost 23$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="12.jpg"  style="width:100%"/>
            <h4>Information revolution. The path to corporate intelligence.</h4>
            <p>By Allan Russell<br><b>Cost 21$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="13.jpg" height="407px" style="width:100%"/>
            <h4>A handbook on public relations in science and technology.</h4>
            <p>By Gary Chapman<br><b>Cost 18$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="14.jpg"height="407px" style="width:100%"/>
            <h4>Organization of a modern educational information environment.</h4>
            <p>By Maria Pobedonostseva<br><b>Cost 18$</b></p>
        </div>
    </div>
    <div class="w3-row-padding w3-padding-16 w3-center">
        <div class="w3-quarter">
            <img src="15.jpg" height="407px" style="width:100%"/>
            <h4>Theory and practice of self-development of students in a multicultural educational environment.</h4>
            <p>By Ivan Artemev<br><b>Cost 15$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="16.jpg" height="407px" style="width:100%"/>
            <h4>Psychology of personality self-development.</h4>
            <p>By Maria Shukina<br><b>Cost 25$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="17.jpg" height="407px" style="width:100%"/>
            <h4>Human psychology.</h4>
            <p>By Gary Chapman<br><b>Cost 18$</b></p>
        </div>
        <div class="w3-quarter">
            <img src="18.jpg" height="407px" style="width:100%"/>
            <h4>Psychology of Personality.</h4>
            <p>By Karina Makarova<br><b>Cost 19$</b></p>
        </div>
    </div>
